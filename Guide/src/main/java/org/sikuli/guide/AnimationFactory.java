...
public class AnimationFactory {
  ...
  static NewAnimator createResizeAnimation(SikuliGuideComponent sklComponent, Dimension currentSize, Dimension targetSize) {
  ...
  static public NewAnimator createOpacityAnimation(
          SikuliGuideComponent sklComponent, float sourceOpacity, float targetOpacity) {
...
class NewAnimator implements ActionListener {
  ...
  SikuliGuideComponent sklComponent;

  NewAnimator(SikuliGuideComponent sklComponent) {
...
class NewMoveAnimator extends NewAnimator {
  ...
  NewMoveAnimator(SikuliGuideComponent sklComponent, Point source, Point destination) {
    super(sklComponent);
    this.source = source;
...
class ResizeAnimator extends NewAnimator {
  ...
  ResizeAnimator(SikuliGuideComponent sklComponent, Dimension currentSize, Dimension targetSize) {
    super(sklComponent);
...
class OpacityAnimator extends NewAnimator {
  ...
  OpacityAnimator(SikuliGuideComponent sklComponent, float sourceOpacity, float targetOpacity) {
    super(sklComponent);
