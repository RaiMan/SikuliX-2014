 ...
 *
 */
#include "org_sikuli_basics_MacHotkeyManager.h"
...
#define HOTKEY_LISTENER_SIGNATURE "(Lorg/sikuli/basics/HotkeyEvent;)V"
#define HOTKEY_EVENT_CLASS "org/sikuli/basics/HotkeyEvent"
...
Java_org_sikuli_basics_MacHotkeyManager_uninstallGlobalHotkey
